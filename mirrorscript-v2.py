...
if __name__ == "__main__":
	...
	# Banner
	print("#")
	print("# Mirrorscripts-v2 - By Hazmirul Afiq modified by @independentcod for MollyEskam-Linux repo on github https://github.com/independentcod/MollyEskam-Linux")
	...
	with open(filename, 'r+') as f:
	    text = f.read()
	    text = re.sub('http://archive.kali.org/kali', new_mirror, text)
	    f.seek(0)
	    f.write(text)
	    f.truncate()
	    print("[+] PART EDITED BY @independentcod - END")
